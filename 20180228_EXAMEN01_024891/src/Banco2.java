...
public class Banco2 implements Banco, Transaccion{
...
public String update(String usuario, String dest, String protocol) {
	...
	public void Prot (String protocol){
		...
		if (stat.equals("salida")){
			System.out.println("Transacción en proceso con un .txt");
		}
		else{
	...
	public String Us(String usuario){
		if(usuario.equals("usuario1")){
			System.out.println("Usuario 1 pertenece a banco 2");
		}else if(usuario.equals("usuario2")){
			System.out.println("Usuario 2 pertenece a banco 2");
		}else if(usuario.equals("usuario3")){
			System.out.println("Usuario 3 pertenece a banco 2");
	}
		return usuario;
